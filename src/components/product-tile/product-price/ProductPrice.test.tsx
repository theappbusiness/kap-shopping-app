...
test('when browser locale set to England, price is formatted to £', () => {
...
test('when browser locale set to Portuguese, price is formatted to €', () => {
...
test('when browser locale set to French, price is formatted to €', () => {
